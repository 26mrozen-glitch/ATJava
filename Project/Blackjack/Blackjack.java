...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        while (playAgain) {
            ...
            if (playerScore == 21 && dealerScore == 21) {
                ...
                System.out.println(
                    "Both you and the dealer have blackjack! It's a draw."
                );
                continue;
    ...
    private static String handToString(
        ArrayList<Card> hand
    ) {
